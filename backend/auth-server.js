...
app.post('/auth/signup', async (req, res) => {
    try {
        ...
        console.log('POST /auth/signup - Registration attempt:', { name, email, age });
        ...
        if (!authResult.success) {
            ...
            switch (authResult.reason) {
                ...
                case reasons.MAX_ATTEMPTS:
                    message = 'Tài khoản tạm thời bị khóa do nhập sai mật khẩu quá nhiều lần';
                    break;
            }
...
app.put('/profile/password', authenticateToken, async (req, res) => {
    try {
        ...
        console.log('PUT /profile/password - Password change attempt for:', req.user.email);
...
app.put('/admin/users/:id/role', authenticateToken, requireAdmin, async (req, res) => {
    try {
        ...
        console.log('PUT /admin/users/:id/role - Admin changing user role:', id, 'to', role);
...
app.post('/auth/forgot-password', async (req, res) => {
    try {
        ...
        console.log('POST /auth/forgot-password - Password reset request for:', email);
...
app.post('/auth/reset-password', async (req, res) => {
    try {
        ...
        console.log('POST /auth/reset-password - Reset password attempt with token');
